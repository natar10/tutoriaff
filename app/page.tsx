        ...
        <div className="rounded-lg bg-gray-50 p-2 shadow-sm">
          ...
          {optimizedRoute && (
            <div className="mt-6 rounded-lg bg-white p-6 shadow-md">
              ...
              {/* Aviso de entregas descartadas */}
              {optimizedRoute.skippedDeliveries && optimizedRoute.skippedDeliveries.length > 0 && (
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-medium text-yellow-800">
                        {optimizedRoute.skippedDeliveries.length} entrega(s) descartada(s)
                      </h3>
                      <div className="mt-2 text-sm text-yellow-700">
                        <p className="mb-1">Las siguientes entregas no pudieron incluirse en la ruta optimizada:</p>
                        <ul className="list-inside list-disc space-y-1">
                          {optimizedRoute.skippedDeliveries.map((skipped, idx) => (
                            <li key={idx}>
                              <span className="font-medium">{skipped.label}</span>
                              {skipped.reason && <span className="text-yellow-600"> — {skipped.reason}</span>}
                            </li>
                          ))}
                        </ul>
                      </div>
